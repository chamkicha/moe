...
class CreateFormerManagersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('former_managers', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignIdFor(Ward::class,'ward_id')->nullable()->index()->constrained();
    ...
    {
        Schema::dropIfExists('former_managers');
    }
}
